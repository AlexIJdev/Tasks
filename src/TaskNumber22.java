...
// Входные данные: вводятся три целых неотрицательных числа:
// n - количество страниц в книге;
// s  - количество страниц, которые прочитывает ВАЛЛ-И каждый день;
// d - количество дней.
// Выходные данные: выведите на экран ответ на задачу: сколько страниц останется прочитать ВАЛЛ-И через d дней.
//
// Sample Input:
//      100
//      10
